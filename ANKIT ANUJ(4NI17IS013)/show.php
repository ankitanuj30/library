...
$sql = "SELECT *FROM registeration1";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
  echo"<table border='1'>";
  echo"<tr><th>Student's pic</th><th>Signature</th><th>reg no</th><th>first name</th><th>last name</th><th>father's name</th><th>mother's name</th><th>email</th><th>branch</th></tr>";
